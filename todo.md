# Project TODO - Dreamweldtech

## Hoàn thành
- [x] Trang chủ (Homepage) với Hero Banner, Giới thiệu, Sản phẩm, Ứng dụng ngành
- [x] Layout chung (Header, Footer, Navigation)
- [x] Tích hợp hình ảnh và font chữ Industrial Precision
- [x] Nâng cấp hệ thống lên Full-stack (Database & Auth)
- [x] Thiết kế cơ sở dữ liệu (Products, News, Categories)
- [x] Tạo API Backend cho sản phẩm và tin tức
- [x] Trang quản trị (Admin Panel) - Dashboard
- [x] Trang quản trị - Quản lý sản phẩm (CRUD)
- [x] Trang quản trị - Quản lý danh mục (CRUD)
- [x] Trang quản trị - Quản lý tin tức (CRUD)
- [x] Trang quản trị - Quản lý yêu cầu liên hệ
- [x] Trang quản trị - Cài đặt website
- [x] Trang danh sách sản phẩm (Products)
- [x] Trang chi tiết sản phẩm (ProductDetail) với bảng thông số kỹ thuật
- [x] Form báo giá sản phẩm
- [x] Trang tin tức/blog (News)
- [x] Trang chi tiết bài viết (NewsDetail)
- [x] Trang Giới thiệu (About)
- [x] Trang Giải pháp (Solutions)
- [x] Trang Liên hệ (Contact) với form
